 ...
 * "/exceptionScenario/initiate" -> A Sample End Point throwing exception, this is to show how to handle business level failures. Ideally we should create
 * 									a custom unchecked exception (say ServiceException) and throw it from here. We can then add a controller advice to have a
